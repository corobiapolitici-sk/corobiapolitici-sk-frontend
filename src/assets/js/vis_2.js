	...
	return {
		...
		tooltip: {
			...
			formatter: function (params) {
				...
				return 'Klub <b>' + clubName + '</b> strávil celkovo <b>' + params.data.value[2] + '</b> minút v rozpravách o parlamentnej tlači č. <b>' + lawName + '</b></br><i>' + visualization2Laws[lawName] + '</i>';
			}
		},
		xAxis: {
...
function visualizationClickHandler2 (params) {
	if (params.data.value[2] !== '-') {
		window.open('https://www.nrsr.sk/web/Default.aspx?sid=zakony%2Fzakon&ZakZborID=13&CisObdobia=7&CPT=' + visualization2LawNames[params.data.value[0]], '_blank');
	}
}
